...
const colors = {
  ...
  appleBtn: '#000000',
  error: '#FF6667',
  userMarkerOverlay1: 'rgba(255, 99, 164,0.2)',
  userMarkerOverlay2: 'rgba(255, 99, 164,0.01)',
  markerBg: 'rgb(74,74,74)',
  divider: 'rgb(240,240,240)',
  offerStatus: {
    waiting: 'rgb(255,170,100)',
    rejected: 'rgb(255, 99, 164)',
  ...
  capacityBg: 'rgba(255, 99, 164, 0.05)',
};
