...
// export default class ModalViewAnimated extends React.Component<Props, State> {
//   static defaultProps = {
...
//     this.state = ModalViewAnimated.getDerivedStateFromProps(props, undefined);
...
//               or(
//                 clockRunning(this.masterClockForOverscroll),
//                 not(wasRunMaster),
//               ),
//             ),
//             [
...
//             return {val: ModalViewAnimated.renumber(s), ind: i};
//           }
