...
const HangoutHelper = ({capacity, onPress, disabled, isMinCapacity}) => {
      ...
      <>
        {!!isMinCapacity && (
          <Touchable
            ...
            <MaterialCommunityIcons
              ...
              size={getSize.f(20)}
            />
            <Text style={stylesMain.label}>{'Helper Minimum'}: </Text>
        ...
        <Touchable
          ...
          <MaterialCommunityIcons
            ...
            size={getSize.f(20)}
          />
          <Text style={stylesMain.label}>{'Helper'}: </Text>
