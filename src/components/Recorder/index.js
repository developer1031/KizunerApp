...
export default class VideoRecorder extends Component {
  ...
  constructor(...props) {
    ...
    this.state = {
      ...
      recorded: false,
      recordedData: null,
      cameraType: this.props.cameraOptions.type,
    };
  }
  ...
  stopCapture = () => {
    const shouldStopCapture = () => {
      this.stopTimer();
      this.camera && this.camera.stopRecording && this.camera.stopRecording();
      this.setState({
        isRecording: false,
      });
    };
        ...
        <Modal
          ...
          <View style={styles.modal}>
            ...
            <View style={styles.container}>
              ...
              <TouchableOpacity
                onPress={this.close}
                style={this.props.buttonCloseStyle}>
                {this.props.renderClose()}
              </TouchableOpacity>
              <TouchableOpacity
                onPress={this.switchCamera}
                style={this.props.buttonSwitchCameraStyle}>
