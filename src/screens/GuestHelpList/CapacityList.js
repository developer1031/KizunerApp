  ...
  const handleUpdateStatus = (offerId, status, userId) => {
    ...
    dispatch(
      updateOfferStatusHelp(
        {id: offerId, status, helpId, userId},
        {
...
const styles = StyleSheet.create({
  ...
  rejectBtn: {
    backgroundColor: orangeLight.colors.offerStatus.rejected,
    width: getSize.h(38),
    height: getSize.h(38),
    borderRadius: getSize.h(38 / 2),
    justifyContent: 'center',
