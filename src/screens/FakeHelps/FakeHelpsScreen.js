...
import {createChatRoom, addMemberToRoom, showAlert} from 'actions';
...
const FakeHelpsScreen = ({navigation, route}) => {
  ...
  function renderItem({item}) {
    return <MemoFeedItemHelp data={item} type={item?.type} />;
  }
  ...
  return (
    <Wrapper style={styles.wrapper}>
      ...
      <FlatList
        data={helps?.length ? helps : helps?.data || []}
...
export default FakeHelpsScreen;
